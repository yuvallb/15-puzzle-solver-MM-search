...
When compared to A^*^ bidirectional search, MM reached optimal solutions, but at higher run times. When compared to unidirectional A^*^ and IDA*, MM was mostly superior.
...
### References
Borowski, B. (2013). Optimal 8/15-Puzzle Solver. Retrieved from [http://brian-borowski.com/software/puzzle/](http://brian-borowski.com/software/puzzle)
Holte, R., Felner, A., Sharon, G., & Sturtevant, N. (2016). Bidirectional Search That Is Guaranteed to Meet in the Middle. Retrieved from [http://www.aaai.org/ocs/index.php/AAAI/AAAI16/paper/view/12320](http://www.aaai.org/ocs/index.php/AAAI/AAAI16/paper/view/12320)
